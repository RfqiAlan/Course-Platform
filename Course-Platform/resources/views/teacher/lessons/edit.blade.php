<x-app-layout :title="'Edit Lesson – '.$lesson->module->title">
    <div class="container py-4">
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h5 mb-1">Edit Lesson</h1>
                <p class="small text-muted mb-0">
                    Modul: <strong>{{ $lesson->module->title }}</strong> – Course: <strong>{{ $lesson->module->course->title }}</strong>
                </p>
            </div>
            <a href="{{ route('teacher.modules.lessons.index',$lesson->module) }}"
                ...
                <form action="{{ route('teacher.lessons.update',$lesson) }}"
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="summary" rows="3"
                                  class="form-control form-control-sm">{{ old('summary',$lesson->summary) }}</textarea>
                    </div>
