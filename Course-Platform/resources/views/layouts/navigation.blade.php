        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('courses.public.index')" :active="request()->routeIs('courses.public.index')">
                        {{ __('Courses') }}
                    </x-nav-link>

                    @auth
                        @if(auth()->user()->role === 'teacher' || auth()->user()->role === 'admin')
                            <x-nav-link :href="route('courses.manage.index')" 
                                        :active="request()->routeIs('courses.manage.*')">
                                {{ __('Manage Courses') }}
                            </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @guest
            <div class="pt-2 pb-3 border-t border-gray-200">
                ...
                <a href="{{ route('register') }}" 
                   class="block px-4 py-2 text-sm text-indigo-600 hover:bg-indigo-50 font-semibold">Register</a>
            </div>
        @endguest
