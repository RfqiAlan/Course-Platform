<x-admin-layout title="Pengaturan Profil">
                            ...
                            <div class="card border-0 shadow-sm rounded-4">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <form method="post" action="{{ route('profile.update') }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="name" class="form-label small fw-semibold text-dark">Nama Lengkap</label>
                            ...
                            <div class="card border-0 shadow-sm rounded-4">
                                ...
                                <div class="card-body p-4">
                                    <form method="post" action="{{ route('password.update') }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="current_password" class="form-label small fw-semibold text-dark">Password Saat Ini</label>
                                            <div class="input-group">
                                                <span class="input-group-text bg-light border-end-0">
